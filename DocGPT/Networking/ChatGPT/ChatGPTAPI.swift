...
class ChatGPTAPI: @unchecked Sendable {
    ...
    func sendMessageStream(text: String, userID: String, groupID: String = "", accessToken: String, givenName: String, placeholderText: String? = nil) async throws -> AsyncThrowingStream<String, Error> {
            ...
            Task(priority: .userInitiated) { [weak self] in
                ...
                do {
                    ...
                    if let placeholderText = placeholderText {
                        chat = [["message": placeholderText, "sender": givenName], ["message": responseText, "sender": "chat-GPT"]]
                    } else {
                        chat = [["message": text, "sender": givenName], ["message": responseText, "sender": "chat-GPT"]]
                    }
